...
<table width="100%">
    ...
    <tr>
        <td class="wshkhidefuncol" style="width:40%;">
            ...
            <p style="border-bottom:1px solid grey;padding-left:20px;"><?php esc_html_e( 'Billing user state code', 'woo-shortcodes-kit' ); ?></p>
            <p style="border-bottom:1px solid grey;padding-left:20px;"><?php esc_html_e( 'Billing user state name', 'woo-shortcodes-kit' ); ?></p>
            <p style="border-bottom:1px solid grey;padding-left:20px;"><?php esc_html_e( 'Billing user country code', 'woo-shortcodes-kit' ); ?></p>
            <p style="border-bottom:1px solid grey;padding-left:20px;"><?php esc_html_e( 'Billing user country name', 'woo-shortcodes-kit' ); ?></p>
