...
?>
<div class="woocommerce cartpops_rule_wrapper cartpops_update_rule">
	<h2><?php esc_html_e( 'Edit Rule', 'cartpops' ); ?></h2>
	<table class="form-table">
		<tbody>
			...
			<tr>
				<th scope='row'>
					<label><?php esc_html_e( 'Rule Name', 'cartpops' ); ?><span class="required">*</span></label>
				</th>
				<td>
	...
	?>
	<p class="submit">
		<input name='cartpops_rule_id' type='hidden' value="<?php echo esc_attr( $rule_data['id'] ); ?>" />
		<input name='cartpops_save' class='button-primary cartpops_save_btn' type='submit' value="<?php esc_attr_e( 'Update Rule', 'cartpops' ); ?>" />
		<?php wp_nonce_field( 'cartpops_update_rule', '_cartpops_nonce', false, true ); ?>
	</p>
</div>
<?php
